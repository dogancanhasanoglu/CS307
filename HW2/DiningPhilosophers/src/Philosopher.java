...
public class Philosopher extends Thread {
	...
	public void run() {
		...
		System.out.println("Philosopher" + Thread.currentThread().getName() + " has passed the barrier");
		...
		while(true){
			...
			take_forks(id);
			System.out.println("Philosopher" + Thread.currentThread().getName() + " has taken the fork");
			table.Eating_GUI(id);
			System.out.println("Philosopher" + Thread.currentThread().getName() + " has put down the fork");
			put_forks(id);
		}
	}	
}
